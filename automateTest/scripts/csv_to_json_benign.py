...
def main(sample_size=None):
    ...
    input_csv = os.path.join(script_dir, 'input', 'input_benign.csv')
    output_json = os.path.join(script_dir, 'output', 'output_benign.json')

    if sample_size is None:
        try:
            sample_size = int(input("Ingrese el tamaño de la muestra para benign: "))
        except ValueError:
